...
CREATE TABLE Documentos (
 id_Documentos INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
 CNPJ_Empresa VARCHAR(15) NOT NULL,
 Situacao VARCHAR(15) NOT NULL,
 Documento VARCHAR(15) NOT NULL,
 Vencimento_Documentos DATE NOT NULL
);

ALTER TABLE Documentos ADD FOREIGN KEY (CNPJ_Empresa) REFERENCES Cadastro_Empresa (CNPJ_Empresa) ON DELETE CASCADE;

CREATE TABLE Mapa (
 id_Mapa INT AUTO_INCREMENT NOT NULL PRIMARY KEY,
 CNPJ_Empresa VARCHAR(15) NOT NULL,
 Risco VARCHAR(15) NOT NULL,
 Fonte VARCHAR(15) NOT NULL,
 Trab_Expostos int NOT NULL,
 Trajetoria VARCHAR(15) NOT NULL,
 Tipo VARCHAR(15) NOT NULL    
);

ALTER TABLE Mapa ADD FOREIGN KEY (CNPJ_Empresa) REFERENCES Cadastro_Empresa (CNPJ_Empresa) ON DELETE CASCADE;